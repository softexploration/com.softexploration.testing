...
public class BeforeActiveAfterActiveExecutionsTest {
	...
	private FixtureSuite createFixtureSuite() {
		...
		fixtureSuite.registerFixture(INCREMENT_NUMBER_A, BeforeActiveAfterActiveExecutionsTest::incrementNumberAby2,
				BeforeActiveAfterActiveExecutionsTest::incrementNumberAby4);
		return fixtureSuite;
	}
